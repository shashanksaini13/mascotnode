...
let fillEncoding = scn.encode(circle, { field: "hzd", channel: "fillColor", scheme: "interpolateRdYlBu" });
...
scn.addInteraction({
    listener: scn,
    event: "zoom",
    hitObject: collection,// collection but legend works for both
    target: circle,
    predicate: [{ field: 'radius' }],
    targetEval: {
