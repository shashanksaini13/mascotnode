...
// let coll = scene.repeat(rect, dt, {field: "Continent", layout: msc.layout("grid")});
//scene.setProperties(coll.layout, {"numCols": 1});

// let coll = scene.divide(rect, dt, {field: "Continent", orientation: "horizontal"});
...
// scene.classify(c, {field: "Continent", layout: msc.layout("grid", {numRows: 1, rowGap: 2, colGap: 2, dir: ["l2r", "b2t"]})});
